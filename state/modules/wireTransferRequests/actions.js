import {
  getWireTransferRequests,
  getWireTransferRequest,
  addWireTransferRequest,
  editWireTransferRequest,
  deleteWireTransferRequest,
  getUserAccountWireTransferRequests,
} from './api'
...
export const fetchGetUserAccountWireTransferRequests = (
  ...
  try {
    const res = await getUserAccountWireTransferRequests(userAccountId, associatedOperation)
...
// Add
export const fetchAddWireTransferRequest = (wireTransferRequest) => async (dispatch) => {
  dispatch(requestAddWireTransferRequest())
  try {
    const res = await addWireTransferRequest(wireTransferRequest)
...
const requestAddWireTransferRequestSuccess = (wireTransferRequest) => {
  return {
