import { getUserAccountMovements, addUserAccountMovement, editUserAccountMovement, deleteUserAccountMovement } from './api';
import types from './types';
import { formatAxiosError } from "../../../common/utils";

// List UserAccountMovements
export const fetchGetUserAccountMovements = (userAccountId) => async dispatch => {
