...
<iframe id="tradingcentral" src={this.handshakeURL()} allowfullscreen="true" frameborder="0" scrolling="no" width="100%" height="2500">
<script async language="javascript">iFrameResize();</script>
`
    console.log(this.handshakeURL())

    return (
      <Document className="static-page">
        <p>dsds </p>
        <Skeleton active loading={this.props.isLoading}>
          {!_.isEmpty(this.state.page.content) ? <InnerHTML html={eso} /> : null}
        </Skeleton>
      </Document>
    )
  }
