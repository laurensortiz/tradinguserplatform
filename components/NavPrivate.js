    ...
    return (
      <>
        ...
        >
          ...
          <li>
            <Link className="menu-item" href="/wire-transfer-requests"><Icon type="dollar"/> <span>WireTransfer</span></Link>
          </li>
          <li>
            <Link className="menu-item" href="/settings"><Icon type="setting"/> <span>Ajustes</span></Link>
          </li>
          <li>
            <Link className="menu-item" onClick={ this.props.onLogout } href="/"><Icon type="logout"/>
              <span>Salir</span></Link>
          </li>
