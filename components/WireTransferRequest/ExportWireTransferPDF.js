...
class Export extends PureComponent {
  ...
  _downloadFile = () => {
              ...
              [
                {
                  ...
                  text: `${
                    wt.transferMethod === 'Banco'
                      ? 'Detalles de Cuenta ( Beneficiario)'
          ...
          table: {
            ...
            body: [
              [
                {
                  text: `${
                    wt.transferMethod === 'Banco' ? 'Número de Cuenta' : 'Número de identificación'
                  }:`,
                  bold: true,
                  fontSize: 13,
                },
                {
                  text: `${
                    wt.transferMethod === 'Banco'
                      ? wt.beneficiaryPersonAccountNumber
                      : wt.beneficiaryPersonID
                  }`,
                  fontSize: 13,
                },
              ],
    ...
    const fileName = this._getExportFileName(true)
