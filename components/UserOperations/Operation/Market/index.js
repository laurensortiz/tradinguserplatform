...
class Market extends Component {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    ...
    if (!_.isEqual(nextProps.marketOperations, prevState.marketOperations)) {
      ...
      if (!nextProps.isAdmin) {
        marketOperationUser = _.filter(nextProps.marketOperations, [
          'userAccount.userId',
    ...
    if (
      ...
      nextProps.fetchGetMarketOperations({ status: 1 }, nextProps.userAccountId)
  ...
  componentDidMount() {
    this.props.fetchGetMarketOperations({ status: 1 }, this.props.userAccountId)
  }
  ...
  _onCloseDetailView = () => {
    ...
    this.props.fetchGetMarketOperations({ status: this.state.dataStatus }, this.props.userAccountId)
  }
