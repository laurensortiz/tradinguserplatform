          ...
          <Form onSubmit={this._handleSubmit} className="auth-form">
            ...
            <Form.Item label={t('brokerGuaranteeCode')}>
              {getFieldDecorator('brokerGuaranteeCode', {
                ...
                <Input
                  placeholder={t('brokerGuaranteeCode')}
            ...
            <Form.Item label={t('referredClientDescription')}>
              {getFieldDecorator('description', {
                ...
                <TextArea
                  placeholder={t('referredClientDescription')}
                  name="description"
                  onChange={this._handleChange}
                />
              )}
            ...
            <Form.Item>
              <Button
                ...
                loading={this.props.isReferralLoading}
              >
                {t('btn sendReference')}
              </Button>
            </Form.Item>
