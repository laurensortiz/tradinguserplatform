...
create TABLE public."WireTransferRequest" (
  ...
  "commissionsReferenceDetail" varchar(800) NULL,
...
alter table public."WireTransferRequest" add "beneficiaryPersonID" varchar(255) NULL;
/*
